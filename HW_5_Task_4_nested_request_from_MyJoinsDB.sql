...
SELECT shopdb.orderdetails.OrderID, shopdb.orderdetails.TotalPrice AS total_amount, shopdb.orderdetails.OrderID FROM shopdb.orderdetails;

SELECT (SELECT shopdb.customers.LName FROM shopdb.customers WHERE shopdb.customers.CustomerNo IN (SELECT shopdb.orders.CustomerNo FROM shopdb.orders)) FROM shopdb.orderdetails;
